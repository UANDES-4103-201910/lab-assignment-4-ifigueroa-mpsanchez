...
event_venues = [EventVenue.new(name: 'Estadio Nacionalftgd', address:'Maraton', capacity: 60000),\
                EventVenue.new(name: 'Estadio Monumentalwc', address:'Exequiel', capacity: 25000),\
                EventVenue.new(name: 'Movistar Arenaasdasd', address:'Matta', capacity: 15000)]
...
events = [Event.new(name:'Festival de la Cancion', description: 'Puro reggaeton',\
          start_date: '2019-04-04', event_venue: event_venues[0]),
          Event.new(name:'Twisted Sister', description: 'Puro rock',\
          start_date: '2019-04-05', event_venue: event_venues[1]),
          Event.new(name:'Bad Bunny', description: 'Puro Trap',\
          start_date: '2019-05-06', event_venue: event_venues[2])]
